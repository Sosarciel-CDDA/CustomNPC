...
import { BoolObj, DamageTypeID, EffectID, Eoc, EocEffect, InlineEoc, NumObj, ParamsEoc, SoundEffectID, SoundEffectVariantID, Spell, SpellFlag, Time } from "@sosarciel-cdda/schema";
